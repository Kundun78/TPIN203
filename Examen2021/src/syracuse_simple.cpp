...
int main(int nargs, char* argv[])
{
    ...
    // On parallélise la boucle for a l'aide de omp, on oublie pas de faire une réduction sur les moyennes
#pragma omp parallel for reduction(+:mean_height,mean_length) num_threads(4) 
