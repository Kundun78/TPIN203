...
int main(int nargs, char* argv[])
{
    ...
    int i_min = dim / numtask * rank;
    int i_max = dim / numtask * (rank + 1);
    // on divise  la longueur en plusieurs dimensions égales (on suppose que dim est divisible par le nombre de threads)
